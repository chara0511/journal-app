  ...
  return (
    ...
    >
      <path
        ...
        visibility="visible"
      />
      <g stroke="none" transform="translate(436.46 45.737)">
        <path
          fill="#fffcee"
          fillOpacity="0.117"
          d="M102.156-75.969C37.122-76.946-19.12-13.728-12.068 50.715-6.134 110.79 54.221 159.423 114.4 151.39c50.227-5.301 95.495-46.635 100.694-97.64 7.037-53.046-27.31-108.379-78.5-124.469-11.025-3.706-22.75-5.604-34.438-5.25z"
        />
        <path
          fill="#fff5cd"
          fillOpacity="0.167"
          d="M98.156-19.563c-36.86 1.25-63.974 44.114-50.656 78.22 8.837 25.482 37.796 40.415 64.063 35.874 22.032-3.103 41.866-19.839 46.32-42.068 7.416-30.72-13.463-66.204-45.275-71.225-4.75-.803-9.63-.9-14.452-.8z"
        />
        <path
          fill="#ffe580"
          fillOpacity="1"
          d="M100.833 16.702c-14.872-.055-25.478 18.14-18.13 31.182 5.887 12.331 24.414 15.653 34.06 5.684 10.243-9.442 7.746-28.64-5.03-34.457-3.354-1.784-7.154-2.537-10.9-2.41z"
        />
        <path
          fill="#ffee81"
          fillOpacity="1"
          d="M101.02 21.193c-14.098-.357-21.895 20.233-10.995 29.194 8.193 7.988 24.79 4.972 27.86-6.737 3.601-10.73-4.918-23.665-16.865-22.457z"
        />
      </g>
